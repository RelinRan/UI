...
public class CarouselPager extends FrameLayout implements ViewPager.OnPageChangeListener, CarouselAdapter.OnDataSetChangeListener {
    ...
    //选中图资源
    private int indicatorSelectedResource = R.drawable.ui_carousel_indicator_selected;
    //未选中图资源
    private int indicatorUnSelectedResource = R.drawable.ui_carousel_indicator_unselected;
    //指示器布局间距
